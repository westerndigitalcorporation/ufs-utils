...
attributes. Due to UFS BSG driver limitations, this version of the
tool can only write descriptors (Config and String descriptors) The
tool is aligned to the UFS 3.0 spec.
